...
julia> b = PaddedArray(a); #copy the contents of `a` and returns a PaddedArray.
 
 julia> b.r # returns the real view of the data. `real(b)` provides the same behaviour.
...
julia> rfft!(b) == rfft(a) # Inplace real-to-complex transformation.
true
...
julia> b.c # returns the complex view of the array, same as complex(b).
...
julia> irfft!(b) # inplace complex-to-real transform, the function returns the real view.
8×8 SubArray{Float64,2,Array{Float64,2},Tuple{UnitRange{Int64},UnitRange{Int64}},false}:
 0.93659   0.87329     0.346501   0.801544   0.941651  0.0877721  0.0995318    0.669844
 0.109875  0.666899    0.838005   0.968509   0.717388  0.531444   0.0668872    0.117582
 0.989863  0.606462    0.89497    0.915566   0.200812  0.290512   0.611392     0.541901
...
5×8 InplaceRealFFT.PaddedArray{Float64,2,false}:
 ...
 julia> p = plan_rfft!(b) # plan_rfft! precomputes the plan and is probably what you want to work with.
...
julia> p\b # This is actually doing this: (p.pinv = plan_irfft!(b); p.pinv*b)
8×8 SubArray{Float64,2,Array{Float64,2},Tuple{UnitRange{Int64},UnitRange{Int64}},false}:
 0.93659   0.87329     0.346501   0.801544   0.941651  0.0877721  0.0995318    0.669844
 0.109875  0.666899    0.838005   0.968509   0.717388  0.531444   0.0668872    0.117582
 0.989863  0.606462    0.89497    0.915566   0.200812  0.290512   0.611392     0.541901
...
julia> bp = plan_brfft!(b) # you can also use the unormalized back-transform
